...
@Service
// TODO: implement from userdetailservice - For Spring Security
public class TransactionService implements UserDetailsService {
    ...
    //TODO: Load user by username function to be added - For Spring Security

    @Override
    public UserDetails loadUserByUsername(String s) throws UsernameNotFoundException {
        System.out.println("In loadUserByUsername function got the name as " + s);

        URI uri = URI.create("http://localhost:9000/user?id=" + s);

        RestTemplate restTemplate1 = new RestTemplate();
        MyUser myUser = restTemplate1.getForObject("http://localhost:9000/user?id=" + s, MyUser.class);
